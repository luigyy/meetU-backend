...
const users = [
    {
        ...
        description: "Motivated and passionate about my major, love my pets and like to party",
        cards: {},
        city: "Alajuela",
        slogan: "This is my life",
        hobbies: "Play videogames",
        idealFirstDate: "Whatever",
        password: "myPassword",
    },
    {
        profileImgURL: "https://www.rd.com/wp-content/uploads/2017/09/01-shutterstock_476340928-Irina-Bg.jpg?fit=640,427",
        sex: "Female",
        university: ["Veritas"],
        major: "Business",
        name: "Carla",
        lastName: "Solis",
        email: "CarlaSolis@gmail.com",
        description: "Motivated and passionate about my major, love my pets and like to party",
        cards: {},
        city: "Heredia",
        slogan: "This is my life",
...
function* saveUsers() {
    for (var i = 0; i < users.length; i++) {
        try {
            const newUser = new user_1.default(users[i]);
            yield newUser.save();
